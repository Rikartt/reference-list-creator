...
The goal is to create a simple, relatively easy to use reference list creator tool that takes the input of a txt file with links to studies/papers and outputs a nice reference list in the chosen style. I'll do it in APA 7.
